/* 
I can see that for txt files, they output the plain ASCII text. However, for image files and executable files,
the first few bytes has the file signature (like .PNG and .ELF)
*/ 
...
int main(int argc, char*argv[]) {
	...
	//    printf("%c", (char)ch);
     ...
     printf("%d %d %s\n", total_lines, total_bytes, argv[1]);
     return 0;
}
