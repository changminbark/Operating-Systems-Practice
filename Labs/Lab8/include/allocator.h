...
/**
 * This calculates the average fragmentation by finding the largest block and dividing it by the total free memory
 * 
 * @param l is the free list
 * @return a ratio that shows the average fragmentation where 0 represents no fragmentation.
 */
